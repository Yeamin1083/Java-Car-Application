...
public class FERRARI_Pista extends javax.swing.JFrame {

   
    public FERRARI_Pista() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ferrari 488 Pista");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(183, 22, -1, -1));
        ...
        jLabel3.setText("- Displacement (liters/cubic inches) 3.9 L/238");
        ...
        jPanel1.add(Back_butt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 23));
        ...
        jLabel10.setText("Price- $330,000");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 397, -1, -1));

        picture_1.setIcon(new javax.swing.ImageIcon("I:\\project\\11.jpg")); // NOI18N
        picture_1.setText("jLabel11");
        ...
        Picture_2.setIcon(new javax.swing.ImageIcon("I:\\project\\ferrari_488_pista (1).jpg")); // NOI18N
    ...
    private void Buy_buttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buy_buttActionPerformed
       ...
       X. Show_price("$330,000");
       X.setVisible(true);
        JOptionPane.showMessageDialog(null,"FERRARI Pista Purchased Successfully! Fill All the Informations...");
