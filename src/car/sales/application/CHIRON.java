...
public class CHIRON extends javax.swing.JFrame {
    ...
    private void Buy_buttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buy_buttActionPerformed
       ...
       X. Show_price("$2,990,000");
       X.setVisible(true);
        JOptionPane.showMessageDialog(null,"CHIRON Purchased Successfully! Fill All the Informations...");
